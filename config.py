config = {
	...
	"output_server_home": "../data/web/",
	"output_pdf_data_files": "../data/web/data/",
	"output_data_pdf_viewer": "../data/web/viewer.html",
	...
	"elastic_index": "arius",
	"elastic_type": "doc",
	"elastic_tmp_file_name":"tmp.json",
	"elastic_docs_dir":"../data/web/data",
