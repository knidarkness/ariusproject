...
config = {
    ...
    "marytts_voice2": {"INPUT_TYPE": "TEXT", "LOCALE": "en_US", "VOICE": "cmu-slt-hsmm", "OUTPUT_TYPE": "AUDIO", "AUDIO": "WAVE", "effect_F0Add_selected": "on", "effect_F0Add_parameters": "f0Add:65.0;"},
