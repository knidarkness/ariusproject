...
var vs="DID="+DID;
	...
	sniffer = new Image(); 
	sniffer.src = 'http:\/\/stats.sa-as.com\/index.php?'+vs+'&'+vsr+'&'+vsd+'&'+purl+'&Fla='+flaver+'&r='+rand;
...
function msrec(e) {
	...
	msxy.src= 'http:\/\/stats.sa-as.com\/tm.php?r='+rand+'&DID='+DID+'&pw='+pw+'&ph='+ph+'&msx='+msx+'&msy='+msy+'&mspage='+window.location.pathname.substring(window.location.pathname.lastIndexOf('\\') + 1) + window.location.search;
}
